...
/datum/game_mode/proc/declare_completion()
	...
	SSdiscord.send2discord_simple(DISCORD_WEBHOOK_PRIMARY, "Раунд закончен. Режим: [name]. [surviving_total] выживших и [ghosts] призраков. ID раунда - [GLOB.round_id]. Раунд длился - [ROUND_TIME_TEXT()]")
	return FALSE
